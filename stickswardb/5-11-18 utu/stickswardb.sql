...
(1, 'Sin Objeto', ' - - - - ', 1, 'img/objeto/sinObjeto.png'),
(2, 'Hacha de Leñador', 'Mediocre', 4, 'img/objeto/hachaDeleñador.png'),
(3, 'Arco Simple', 'Comun', 5, 'img/objeto/arcoSimple.png'),
(4, 'Armadura Pesada', 'Comun', 6, 'img/objeto/armaduraPesada.png'),
(5, 'Arco Largo', 'Buena', 7, 'img/objeto/arcoLargo.png'),
(6, 'Arco Compuesto', 'raro', 8, 'img/objeto/arcoCompuesto.png'),
(7, 'Armadura de mithril', 'raro', 9, 'img/objeto/armaduraDeMithril.png');
